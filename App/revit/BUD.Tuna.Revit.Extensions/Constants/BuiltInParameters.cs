...
namespace BUD.Tuna.Revit.Extensions.Constants;
...
public class BuiltInParameters
{
    ...
    {
        public static ElementId ElementLayoutRule { get; } = new ElementId(BuiltInParameter.REBAR_ELEM_LAYOUT_RULE);
    }

    public static class Pipe
    {
        public static ElementId Diameter { get; } = new ElementId(BuiltInParameter.RBS_PIPE_DIAMETER_PARAM);
    }
    ...
    public static class Element
    {
        ...
        public static ElementId Comments { get; } = new ElementId(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS);
    }
}
