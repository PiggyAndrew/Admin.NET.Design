...
internal class RibbonPanelProxy : RibbonElementProxy<Autodesk.Revit.UI.RibbonPanel>, IRibbonPanel
{
    ...
    {
        TextBoxData textBoxData = new TextBoxData("test");
        var textbox = OriginalObject.AddItem(textBoxData) as TextBox;
        var method = typeof(TextBox).GetMethod("getTextBox", BindingFlags.Instance | BindingFlags.NonPublic);
        RibbonTextBox ribbonTextBox = method.Invoke(textbox, []) as RibbonTextBox;
        ribbonTextBox.AcceptTextOnLostFocus = true;
        return this;
    }
