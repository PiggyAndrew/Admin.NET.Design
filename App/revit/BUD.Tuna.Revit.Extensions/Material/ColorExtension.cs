...
namespace BUD.Tuna.Revit.Extensions.Material;
...
public static class ColorExtension
{
    ...
    /// <summary>
    /// 将指定的 <see cref="Color"/> 转换为 <see cref="Autodesk.Revit.DB.Color"/>
    /// <para>Convert <see cref="Color"/> to <see cref="Autodesk.Revit.DB.Color"/></para>
    /// </summary>
    /// <param name="color">要转换的颜色</param>
    /// <returns><see cref="Autodesk.Revit.DB.Color"/></returns>
    public static Autodesk.Revit.DB.Color ConvertToRevitColor(this Color color)
    {
