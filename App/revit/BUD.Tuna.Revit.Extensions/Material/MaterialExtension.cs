...
namespace BUD.Tuna.Revit.Extensions.Material
{
    ...
    public static class MaterialExtension
    {
        ...
        public static Color GetAppearanceColor(this Autodesk.Revit.DB.Material material)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public static void SetAppearanceColor(this Autodesk.Revit.DB.Material material, Color color)
        {
            ArgumentNullExceptionUtils.ThrowIfNullOrInvalid(material);
