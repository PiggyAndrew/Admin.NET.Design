...
namespace BUD.Tuna.Revit.Extensions.Extensions;
...
public static class DocumentExtension
{
    ...
    public static TElement GetElement<TElement>(this Document document, Reference reference) where TElement : Element
    {
        return document.GetElement(reference) as TElement ?? throw new Exception("element is not target element type");
    }

    public static TElement GetElement<TElement>(this Document document, ElementId elementId) where TElement : Element
    {
        return document.GetElement(elementId) as TElement ?? throw new Exception("element is not target element type");
    }


    public static void SaveAndCloseFamily(this Document doc, string path)
    {
